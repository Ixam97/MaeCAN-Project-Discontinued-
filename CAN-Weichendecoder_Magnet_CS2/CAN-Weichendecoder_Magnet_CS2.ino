/*
 * MäCAN-Weichendecoder Rev A, Software-Version 0.3
 * 
...
#define BOARD_NUM 32      //Identifikationsnummer des Boards (Anzeige in der CS2)

#include <MCAN.h>
#include <EEPROM.h>
#include <avr/pgmspace.h>

#define UID 0x12345678    //UID
byte uid_mat[4];
...
void sendConfig(int index){
  ...
  byte config_frames[][10][8] = {{
      ...
      {1,1,2,0,0,0,0,EEPROM.read(0)},
      {'B','e','t','r','i','e','b','s'},
      {'a','r','t',0,'M','o','m','e'},
      {'n','t',0,'D','a','u','e','r'}
    },{
      {2,1,2,1,0,0,0,EEPROM.read(1)},
      {'L','a','g','e','m','e','l','d'},
      {'u','n','g',0,'A','u','s',0},
      {'E','i','n',0,0,0,0,0}
    },{
      ...
      {4,1,2,0,0,0,0,EEPROM.read(0x30)},
      {'P','r','o','t','o','k','o','l'},
      {'l',' ','A','u','s','g','a','n'},
      {'g',' ','1',0,'D','C','C',0},
      {'M','o','t','o','r','o','l','a'}
      ...
      {6,1,2,0,0,0,0,EEPROM.read(0x31)},
      {'P','r','o','t','o','k','o','l'},
      {'l',' ','A','u','s','g','a','n'},
      {'g',' ','2',0,'D','C','C',0},
      {'M','o','t','o','r','o','l','a'}
      ...
      {8,1,2,0,0,0,0,EEPROM.read(0x32)},
      {'P','r','o','t','o','k','o','l'},
      {'l',' ','A','u','s','g','a','n'},
      {'g',' ','3',0,'D','C','C',0},
      {'M','o','t','o','r','o','l','a'}
      ...
      {10,1,2,0,0,0,0,EEPROM.read(0x33)},
      {'P','r','o','t','o','k','o','l'},
      {'l',' ','A','u','s','g','a','n'},
      {'g',' ','4',0,'D','C','C',0},
      {'M','o','t','o','r','o','l','a'}
